...
@Service
public class FeedbackServiceImplementation {
    ...
    public FeedbackServiceImplementation() {
    }

    public FeedbackServiceImplementation(FeedbackRepository feedbackRepository, TrainerRepository trainerRepository, StudentRepository studentRepository) {
