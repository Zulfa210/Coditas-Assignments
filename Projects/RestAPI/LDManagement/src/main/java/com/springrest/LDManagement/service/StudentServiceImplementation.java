...
public class StudentServiceImplementation {
    ...
    public StudentServiceImplementation(StudentRepository studentRepository, UserRepository userRepository, DomainRepository domainRepository) {
    ...
    public StudentServiceImplementation(UserRepository userRepository) {
        this.userRepository = userRepository;
    }

    public StudentServiceImplementation(DomainRepository domainRepository) {
        this.domainRepository = domainRepository;
    }
