...
<td><%= name %></td>
    ...
    <div class="tab-pane fade" id="pills-course" role="tabpanel" aria-labelledby="pills-course-tab" >
        ...
        try {
                    ...
                    ResultSet resultSet1 = statement1.executeQuery("select * from courses where teacher_name in (select t.name from teacher t inner join studentTeacher st on t.id = st.teacher_id inner join student s on st.student_id = s.id where t.id=" + id +")");
